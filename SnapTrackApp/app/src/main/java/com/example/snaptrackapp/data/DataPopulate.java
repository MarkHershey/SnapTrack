            ...
            public void update(Map<String, UserActivityInfo> stringUserActivityInfoMap) {
                if (stringUserActivityInfoMap != null) {
                    ...
                    for (String aid: aidList) {
                        try {
                            Date sTime = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").parse("2020-12-02 15:10:00");
                            Date eTime = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").parse("2020-12-02 19:10:00");
